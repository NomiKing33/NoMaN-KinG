...
def main_apv():
    ...
    try:
        ...
        os.system("xdg-open https://wa.me/+923165907481")

        

    r1=requests.get("https://raw.githubusercontent.com/Asif-Noor-06/OLD/main/Approval.txt").text
    ...
    if key1 in r1:
        ...
        print ("          YOUR KEY : "+Mr NoMi KinG+key1)
...
def R():
			...
			if key in [""]:
				...
				os.system('xdg-open https://wa.me/+9233406758952')
...
\033[1;94m ⇨AUTHOR    : NomaN KinG

\033[1;95m ⇨WHATSAPP  : +923165907481

\033[1;96m ⇨FACEBOOK  : NoMaN Khalid  (KinG)

\033[1;93m ⇨INSTA     : Nomiking03

\033[1;91m ⇨VERSION   : 0.2 UPDATE ON 05 May
...
def dupcutter():
	...
	os.system("xdg-open https://wa.me/+923406758952")
